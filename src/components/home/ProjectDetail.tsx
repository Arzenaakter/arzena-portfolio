...
const ProjectDetail: React.FC<ProjectDetailProps> = ({
  ...
  const isModalOpen = Boolean(project && isOpen);
    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          {/* Modal Content */}
          <motion.div
            className="relative w-full max-w-4xl max-h-[90vh] bg-linear-to-br from-white/10 to-white/5 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl overflow-hidden"
          ...
          >
            ...
            >
              ...
              <motion.div className="mb-8" variants={itemVariants}>
                ...
                <motion.div
                  className="h-1 w-20 bg-linear-to-r from-primary to-secondary rounded-full"
                  initial={{ width: 0 }}
                  animate={{ width: 80 }}
              ...
              <motion.div className="mb-8" variants={itemVariants}>
                ...
                <div className="flex flex-wrap gap-3">
                  {project.technologies.map((tech, index) => (
                    <motion.span
                      key={index}
                      className="px-3 py-1 bg-linear-to-r from-primary/20 to-secondary/20 text-white text-sm font-medium rounded-lg border border-primary/30 backdrop-blur-sm"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {project.features.map((feature, index) => (
                      <motion.div
                        ...
                        transition={{ duration: 0.2 }}
                      >
                        <div className="w-2 h-2 rounded-full bg-linear-to-r from-primary to-secondary"></div>
              ...
              >
                <motion.a
                  ...
                  className="flex-1 px-6 py-3 bg-linear-to-r from-primary/20 to-secondary/20 rounded-lg border border-primary/30 transition-all overflow-hidden text-primary flex items-center justify-center font-semibold"
